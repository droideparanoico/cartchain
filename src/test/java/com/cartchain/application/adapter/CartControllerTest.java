package com.cartchain.application.adapter;

import com.cartchain.application.exception.CartAlreadyExistsException;
import com.cartchain.application.exception.CartNotFoundException;
import com.cartchain.application.exception.ControllerExceptionHandler;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.cartchain.domain.model.Cart;
import com.cartchain.domain.model.Item;
import com.cartchain.domain.ports.inbound.CartServicePort;
...
class CartControllerTest {
    ...
    void should_not_save_null_cart() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/carts/" + id)
                ...
                .andExpect(result -> Assertions.assertEquals(ControllerExceptionHandler.INVALID_BODY, result.getResponse().getContentAsString()));
    }
